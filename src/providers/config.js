...
var CoreConfigProvider = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.appDB.deleteRecords(this.TABLE_NAME, { name: name })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.appDB.getRecord(this.TABLE_NAME, { name: name })];
                    case 3:
                        entry = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.appDB.insertRecord(this.TABLE_NAME, { name: name, value: value })];
                }
            });
        });
    };
    CoreConfigProvider = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [CoreAppProvider])
    ], CoreConfigProvider);
    return CoreConfigProvider;
}());
export { CoreConfigProvider };
var CoreConfig = /** @class */ (function (_super) {
    __extends(CoreConfig, _super);
    function CoreConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return CoreConfig;
}(makeSingleton(CoreConfigProvider)));
export { CoreConfig };
